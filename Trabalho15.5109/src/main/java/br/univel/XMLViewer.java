...
public class XMLViewer extends javax.swing.JFrame {
    ...
    public XMLViewer(String cliente, String produto) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("XMLProduto");

        jLabel2.setText("XMLCliente");

        taProduto.setColumns(20);
        taProduto.setRows(5);
        jScrollPane2.setViewportView(taProduto);

        taCliente.setColumns(20);
        taCliente.setRows(5);
        scrollPane1.add(taCliente);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(XMLViewer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void mostrar() {
       taProduto.setText(produto);
       taCliente.setText(cliente);
    }
}
